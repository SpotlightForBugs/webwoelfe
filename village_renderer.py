...
class VillageRenderer:
    ...
    def _render_spieler(
        ...
        if spieler.ist_am_leben:
            ...
            kopf_y = y - 40
            draw.ellipse(
                [x - 10, kopf_y - 10, x + 10, kopf_y + 10], fill=(220, 185, 155)
            )
            ...
            draw.ellipse(
                [x - 4 + auge_offset_x, kopf_y - 2, x - 2 + auge_offset_x, kopf_y + 2],
                fill=(40, 40, 40),
            )
            draw.ellipse(
                [x + 2 + auge_offset_x, kopf_y - 2, x + 4 + auge_offset_x, kopf_y + 2],
                fill=(40, 40, 40),
            )
